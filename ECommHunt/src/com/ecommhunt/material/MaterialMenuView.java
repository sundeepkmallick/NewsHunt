package com.ecommhunt.material;
...
import static com.ecommhunt.material.MaterialMenuDrawable.DEFAULT_COLOR;
import static com.ecommhunt.material.MaterialMenuDrawable.DEFAULT_PRESSED_DURATION;
import static com.ecommhunt.material.MaterialMenuDrawable.DEFAULT_SCALE;
import static com.ecommhunt.material.MaterialMenuDrawable.DEFAULT_TRANSFORM_DURATION;
import static com.ecommhunt.material.MaterialMenuDrawable.IconState;
import static com.ecommhunt.material.MaterialMenuDrawable.Stroke;
...
public class MaterialMenuView extends View implements MaterialMenu {
	...
	private void init(Context context, AttributeSet attributeSet) {
		...
		try {
			...
			// DEFAULT_COLOR);
			// int scale =
			// attr.getInteger(R.styleable.MaterialMenuView_mm_scale,
			// DEFAULT_SCALE);
			// int transformDuration =
			// attr.getInteger(R.styleable.MaterialMenuView_mm_transformDuration,
			// DEFAULT_TRANSFORM_DURATION);
			// int pressedDuration =
			// attr.getInteger(R.styleable.MaterialMenuView_mm_pressedDuration,
			// DEFAULT_PRESSED_DURATION);
			// Stroke stroke =
			// Stroke.valueOf(attr.getInteger(R.styleable.MaterialMenuView_mm_strokeWidth,
			// 0));
			// boolean rtlEnabled =
			// attr.getBoolean(R.styleable.MaterialMenuView_mm_rtlEnabled,
			// false);
			int color = Color.BLUE;
			int scale = DEFAULT_SCALE;
			int transformDuration = DEFAULT_TRANSFORM_DURATION;
			int pressedDuration = DEFAULT_PRESSED_DURATION;
			Stroke stroke = Stroke.valueOf(2);
